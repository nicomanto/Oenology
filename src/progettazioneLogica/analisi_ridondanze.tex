Lo schema concettuale rappresenta un attributo ridondante, cioè il \textbf{PrezzoTotale} nell'entità \emph{Ordine}. Questo attributo è derivabile da $\sum_{n = 1}^{j} (PrezzoBottiglia_n \times Quantita'Bottiglie_n) + PrezzoSpedizione$, 
