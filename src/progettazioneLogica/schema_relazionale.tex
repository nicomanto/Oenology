...
\begin{center}
	\begin{minipage}[t]{7.5cm}
		\rightline{
			\begin{tabular}{P{7.5cm}}
				\toprule\rowcolor[rgb]{.929, .929, .929} \textbf{LineeProduttive} (\underline{Id}, Nome, Direttore)                           \\
				\midrule
	...
	\begin{minipage}[t]{7.5cm}
		\rightline{
			\begin{tabular}{P{7.5cm}}
				\toprule\rowcolor[rgb]{.929, .929, .929} \textbf{Ordini} (\underline{Id}, PrezzoTotale *, Data, Acquirente)                                                    \\
				\midrule
