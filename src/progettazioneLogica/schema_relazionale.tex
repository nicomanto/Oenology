...
\begin{center}
	\begin{minipage}[t]{7.5cm}
		\rightline{
			\begin{tabular}{P{7.5cm}}
				\toprule
				\rowcolor[rgb]{.929, .929, .929} \textbf{FornituraTappo} (\underline{Tappo, DataAcquisto}, Prezzo, Quantita) \\
				\midrule
				...
				\rowcolor[rgb]{.929, .929, .929} \textbf{Dettagli} (\underline{Ordine, Vino}, QuantitaBottiglie)             \\
				\midrule
	...
	TemiVino.Evento $\to$ Eventi.Id                                                                                                                \\                                \\
				...
				\rowcolor[rgb]{.929, .929, .929} \textbf{Acquirenti} (\underline{Id})                                                                                                              \\                                \\
				\midrule
	...
	\begin{minipage}[t]{7.5cm}
		\rightline{
			\begin{tabular}{P{7.5cm}}
				\toprule
				\rowcolor[rgb]{.929, .929, .929} \textbf{FornituraBottiglia} (\underline{Bottiglia, DataAcquisto}, Prezzo, Quantita)                                   \\
				\midrule
				...
				\rowcolor[rgb]{.929, .929, .929} \textbf{Aziende} (\underline{Id}, NumAcquirente, PartitaIva, NomeReferente, CognomeReferente, InformazioniAggiuntive) \\
				\midrule
