...
\end{verse}
\begin{verse}
	Le \textbf{entita'} \emph{ProduzioneVino, Imbottigliamento, NegozioInterno, MagBianco, MagRosso, MagRosato, MagSpumante, FornitoreUva, FornitoreTappi, FornitoreBottiglie} sono prive di attributi.
\end{verse}
...
\begin{tabular}{P{4cm}P{2cm}P{8cm}}
	...
	\midrule
	Prezzo & DECIMAL &  Rappresenta il prezzo della materia prima\\
	\bottomrule
\end{tabular}
