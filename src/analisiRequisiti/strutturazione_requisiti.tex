\begin{center}
	...
	\begin{tabular}{P{16cm}}
		...
		\midrule
		La tipologia di uva con cui è stata prodotta, caratterizzata dalla vedemmia (data raccolta) e dal colore. L'uva viene identificata tramite la tipologia e la vendemmia. L'uva proviene da un tipo di vigna. L'uva è fornita da aziende esterne.\\
		\bottomrule
	\end{tabular}
